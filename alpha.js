...
function uncache(module = '.') {
   ...
   console.log(chalk.bold.green(figlet.textSync('LynnBotz', {
      font: 'Standard',
...
const message = {
            interactiveMessage: {
                ...
                nativeFlowMessage: {
                    buttons: [
                        {
                "name": "quick_reply",
                "buttonParamsJson": `{"display_text":"${dispText}","id":"${butId}"}`
              }
                    ],
                    messageParamsJson: ''
                }
       ...
       alpha.relayMessage(jid, { viewOnceMessage: { message } }, {});
     ...
     const message = {
            interactiveMessage: {
                ...
                "buttonParamsJson": `{"display_text":"${dispText}","id":"${butId}"}`
                        ...
                        {
                "name": "quick_reply",
                "buttonParamsJson": `{"display_text":"${dispText2}","id":"${butId2}"}`
              }
                    ],
                    messageParamsJson: ''
                }
